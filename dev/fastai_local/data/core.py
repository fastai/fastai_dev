...
__all__ = ['get_files', 'file_getter', 'image_extensions', 'get_image_files', 'image_getter', 'random_splitter',
           'grandparent_splitter', 'parent_label', 're_labeller', 'show_image', 'show_title', 'show_image_batch',
...
def file_getter(suf='', extensions=None, recurse=True, include=None):
...
def image_getter(suf='', recurse=True, include=None):
