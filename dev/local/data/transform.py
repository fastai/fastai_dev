...
__all__ = ['anno_ret', 'cmp_instance', 'ShowTitle', 'Int', 'Float', 'Str', 'TypeDispatch', 'TfmMeta', 'Transform']
...
class Transform(metaclass=TfmMeta):
    ...
    def func(self, is_enc, x, filt=None):
        if self.as_item: return self.lookup(is_enc,x)
