...
#         if type_tfms is None: type_tfms = [None]
        ...
        # TODO: refactor to mk_pipeline
        if isinstance(ds_tfms,Pipeline): self.ds_tfms = ds_tfms
        else:
...
#         return ctx
    ...
    def subset(self, idxs):
        return self.__class__(self.items[idxs], self.tls, self.ds_tfms, do_setup=False)
