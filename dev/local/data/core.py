#AUTOGENERATED! DO NOT EDIT! File to edit: dev/05_data_core2.ipynb (unless otherwise specified).
...
class TfmdDL(DataLoader):
    ...
    def __init__(self, dataset, batch_tfm=None, item_tfm=None, **kwargs):
        batch_tfm = with_self(Pipeline(batch_tfm, as_item=False))
        item_tfm  = with_self(Pipeline(item_tfm , as_item=True ))
        super().__init__(dataset, batch_tfm=batch_tfm, item_tfm=item_tfm, **kwargs)
        self._dl_types = None
