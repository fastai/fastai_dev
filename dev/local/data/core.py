...
__all__ = ['get_files', 'FileGetter', 'image_extensions', 'get_image_files', 'ImageGetter', 'RandomSplitter',
           'GrandparentSplitter', 'parent_label', 'RegexLabeller', 'Categorize', 'show_image', 'show_title',
           'show_titled_image', 'show_image_batch', 'TfmDataLoader', 'Cuda', 'Normalize', 'DataBunch']
...
class Categorize(Transform):
    ...
    def shows(self, o, ctx=None): show_title(o, ax)
