#AUTOGENERATED! DO NOT EDIT! File to edit: dev/01a_dispatch.ipynb (unless otherwise specified).

__all__ = ['type_hints', 'anno_ret', 'cmp_instance', 'TypeDispatch']
...
class TypeDispatch:
    ...
    def __getitem__(self, k):
        "Find first matching type that is a super-class of `k`"
        a0,a1 = (k if isinstance(k, tuple) else (k,object))
        r = self.funcs.all_matches(a0)
