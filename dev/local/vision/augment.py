...
__all__ = ['RandTransform', 'PILFlip', 'PILDihedral', 'clip_remove_empty', 'CropPad', 'RandomCrop', 'RandomScaledCrop',
           'AffineCoordTfm', 'affine_mat', 'mask_tensor', 'flip_mat', 'Flip', 'dihedral_mat', 'Dihedral', 'rotate_mat',
           'Rotate', 'zoom_mat', 'Zoom', 'find_coeffs', 'apply_perspective', 'Warp', 'logit', 'LightingTfm',
           'Brightness', 'setup_aug_tfms', 'aug_transforms']
...
class RandomCrop(CropPad):
    "Center crop an image to `size`"
    def __init__(self, size, filt=0): super().__init__(size, filt)
