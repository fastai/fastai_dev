...
__all__ = ['Image', 'load_image', 'PILBase', 'PILImage', 'PILMask', 'TensorPoint', 'BBox', 'TensorBBox',
...
class TensorBBox(tuple):
    ...
    def __new__(self, x):
        return super().__new__(TensorBBox, (tensor(x[0]).view(-1, 4).float(), x[1]))
...
class BBoxCategorize(Transform):
    ...
    def encodes(self, o:BBox)->TensorBBox:
        return TensorBBox((o.bbox,tensor([self.otoi[o_] for o_ in o.lbl if o_ in self.otoi])))
