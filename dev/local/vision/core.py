...
__all__ = ['Image', 'Imagify', 'Mask', 'Maskify', 'TensorPoint', 'Pointify', 'TensorBBox', 'BBoxify', 'get_annotations',
...
class Imagify(Transform):
    ...
    def __init__(self, open_func=Image.open): self.open_func = open_func
    def encodes(self, fn)->PIL.Image.Image: return self.open_func(fn)
