...
__all__ = ['FitOneBatchCallback', 'TerminateOnNaNCallback', 'TrackerCallback', 'EarlyStoppingCallback',
...
#Cell
class FitOneBatchCallback(Callback):
    "Fit a single batch then stop. Useful for testing/debugging"
