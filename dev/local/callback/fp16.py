...
__all__ = ['get_master', 'to_master_grads', 'to_model_params', 'test_overflow', 'grad_overflow', 'copy_clone',
           'MixedPrecisionBeginning', 'MixedPrecision']
...
#Cell
class MixedPrecisionBeginning(Callback):
    "Parts of the MixedPrecision callback that need to run at the very beginning"
...
def to_fp16(self:Learner, **kwargs):
    self.add_cbs([MixedPrecisionBeginning(), MixedPrecision(**kwargs)])
    return self