...
__all__ = ['type_hints', 'anno_ret', 'cmp_instance', 'subplots', 'default_show_multi', 'TensorImageBase', 'TensorImage',
           'TensorImageBW', 'TensorMask', 'TypeDispatch', 'Transform', 'InplaceTransform', 'TupleTransform',
           'ItemTransform', 'get_func', 'Func', 'Sig', 'compose_tfms', 'mk_transform', 'gather_attrs',
...
def default_show_multi(b, max_n=10, ctxs=None, **kwargs):
    ...
    return [b_.show(ctx=c_, **kwargs) for b_,c_,_ in zip(b,ctxs,range(max_n))]
