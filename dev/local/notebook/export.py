...
def _deal_import(code_lines, fname):
    ...
    for line in code_lines:
        line = re.sub('_'+'file_', '__'+'file__', line) #Need to break ___file___ or that line will be treated
...
def _reset_index():
    if (Path(__file__).parent/'index.txt').exists(): os.remove(Path(__file__).parent/'index.txt')
