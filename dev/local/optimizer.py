...
__all__ = ['Optimizer', 'sgd_step', 'weight_decay', 'defaults', 'l2_reg', 'defaults', 'average_grad', 'defaults',
           'average_sqr_grad', 'defaults', 'momentum_step', 'SGD', 'rms_prop_step', 'defaults', 'RMSProp', 'step_stat',
           'adam_step', 'Adam', 'larc_layer_lr', 'defaults', 'larc_step', 'Larc', 'lamb_step', 'Lamb']
