...
__all__ = ['make_vocab', 'TensorText', 'LMTensorText', 'Numericalize', 'Text', 'LMDataLoader', 'pad_collate',
           'SortedDL']
...
class Text(ShowTitle):
    ...
    @classmethod
    def create(cls, *args, **kwargs): raise Exception("You need to use an instance of the type `Text` created with a vocab.")
