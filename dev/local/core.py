...
__all__ = ['chk', 'tensor', 'add_docs', 'docs', 'custom_dir', 'is_iter', 'coll_repr', 'GetAttr', 'L', 'defaults',
           'ifnone', 'noop', 'noops', 'tuplify', 'uniqueify', 'setify', 'is_listy', 'range_of', 'mask2idxs', 'apply',
