...
__all__ = ['chk', 'ifnone', 'noop', 'noops', 'range_of', 'is_iter', 'mapper', 'make_cross_image', 'coll_repr',
           'partialler', 'custom_dir', 'add_props', 'add_docs', 'docs', 'GetAttr', 'ListContainer', 'listify',
           'tuplify', 'tensor', 'compose', 'uniqueify', 'setify', 'mask2idxs', 'is_listy', 'opt_call', 'all_union',
           'all_disjoint']
...
class ListContainer(GetAttr):
    ...
    def __setitem__(self, idx, o):
        idx = idx if isinstance(idx,ListContainer) else _listify(idx)
...
def listify(o):
    "Make `o` a list."
    if o is None: return []
    if isinstance(o, (list,ListContainer)): return o
    if isinstance(o, (str,np.ndarray,Tensor)): return [o]
    if is_iter(o): return list(o)
    return [o]
